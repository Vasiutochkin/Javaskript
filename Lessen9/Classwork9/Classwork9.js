...
for (const coArrEl of coursesArray) {
    let div = document.createElement("div");
    ...
    title.innerText = coArrEl.title;
    monthDuration.innerText = coArrEl.monthDuration;
    hourDuration.innerText = coArrEl.hourDuration;

    for (const module of coArrEl.modules) {
